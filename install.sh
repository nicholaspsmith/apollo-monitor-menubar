...
First-run setup
  1. Grant Accessibility when prompted (System Settings ▸ Privacy & Security ▸
     Accessibility). This is required for the ⌘⌥↑ / ⌘⌥↓ hotkeys only — the menu
     and slider work without it. Until granted, the menu shows
     "⚠ Grant Accessibility…"; the hotkeys start working the moment you allow it.
...
Test: click the menu-bar icon and drag the slider, or press ⌘⌥↑ / ⌘⌥↓.
