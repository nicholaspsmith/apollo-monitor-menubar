...
// --login on|off|status registers, unregisters or reports Start at Login and
// exits — the shared StatusItemKit entry point, since SMAppService can only
// register the calling process's own bundle.
LoginCLI.runIfRequested(arguments: arguments)
